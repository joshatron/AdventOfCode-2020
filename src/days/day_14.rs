...
impl Computer {
  ...
  fn set_memory(&mut self, address: u64, value: u64) {
    self
      .memory
      .insert(address, self.get_bitmasked_number(value));
  }
  ...
  fn set_memory(&mut self, address: u64, value: u64) {
    ...
    for i in 0..usize::pow(2, self.x_bits.len().try_into().unwrap()) {
      ...
      for (j, x_bit) in self.x_bits.iter().enumerate() {
        if usize::pow(2, j as u32) & i != 0 {
          new_address = new_address | u64::pow(2, *x_bit as u32);
        } else {
          new_address = new_address & !u64::pow(2, *x_bit as u32);
        }
      }
...
mod tests {
  ...
  fn test_create_computer() {
    ...
    assert_eq!(
      computer.bitmask_ones,
      0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000
    );
    assert_eq!(
      computer.bitmask_zeros,
  ...
  fn test_parse_command() {
    assert_eq!(
      parse_command("mask = XXXXXXXXXXXXXXXXXXXXXXXXXXXXX1XXXX0X"),
      Command::SetMask("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX1XXXX0X")
    );
    assert_eq!(parse_command("mem[8] = 11"), Command::SetMemory(8, 11));
    assert_eq!(
      parse_command("mem[186] = 1786"),
      Command::SetMemory(186, 1786)
    );
  }
  ...
  fn test_run_command() {
    ...
    assert_eq!(
      computer.bitmask_ones,
      0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0100_0000
    );
    assert_eq!(
      computer.bitmask_zeros,
